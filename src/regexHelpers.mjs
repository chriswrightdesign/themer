...
/**
 * Finds input[type="text"] or input[type=text], captures 'type' and 'text' as attribute and contents named groups.
 */
export const selectorBracketsRegex = /\[(?<attribute>\w+)=("?)(?<contents>\w+)("?)\]/ig;